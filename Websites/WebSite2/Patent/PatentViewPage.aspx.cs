...
public partial class GrantEntry_PatentViewPage : System.Web.UI.Page
{
    ...
    private void SelectPatent(object sender, GridViewEditEventArgs e)
    {
        ...
        PopAppStage.Visible = false;
        PanelMU.Enabled = false;
        btnSaveRenewal.Visible = false;
        PoppanelRenewal.Visible = false;
        ...
        if (Pat.Entry_status == "Submitted")
        {
            panelPatentCanelRemark.Visible = false;
        }
        ...
        if (Pat.Entry_status == "Cancelled")
        {
            panelPatentCanelRemark.Visible = true;
            txtCancelRemarks.Text = Pat.CancelRemarks;
        }
        else
        {
            panelPatentCanelRemark.Visible = false;
        ...
        if (dtCurrentTable.Rows.Count > 0)
        {
            for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
            {
                ...
                if (DropdownMuNonMu.Text == "M")
                {
                    ...
                    if (dtCurrentTable.Rows[i - 1]["Department"].ToString() != "")
                    {
    ...
    protected void Btn_Renewal_View(object sender, EventArgs e)
    {
        setModalWindowRenewal(sender, e);
    }
