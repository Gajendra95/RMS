<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="ManageImpactFactor.aspx.cs" Inherits="ManageJournal_ManageImpactFactor" %>
...
.modelPopup
{
 ...
 <asp:Panel ID="panel" runat="server" GroupingText="Managing Impact Factor" Font-Bold="true" Font-Underline="true" BackColor="#E0EBAD">
   <table border="1" style="width: 100%">
                    <tr>
                        ...
                        <td style="height: 36px">             
                             <asp:TextBox ID="txtboxID" runat="server"  OnTextChanged="JournalIDTextChanged"  AutoPostBack="true" Width="200px" Enabled="false" ></asp:TextBox>
    ...
    ControlToValidate="txtboxID" ValidationGroup="Validation"></asp:RequiredFieldValidator>
                        ...
                        <asp:TextBox ID="txtboxTitle" runat="server"  Width="600px" TextMode ="MultiLine" Enabled="false" ></asp:TextBox>       </td>
                 ...
                 <td style="height: 36px">
                        ...
                        <td style="height: 36px" >             
             <asp:DropDownList ID="dropdownCategory" runat="server"  DataSourceID="SqlDataSource4" DataTextField="Category_Name" DataValueField="Category_Id" AppendDataBoundItems="true" Enabled="false">
          ...
          <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ...
                ProviderName="System.Data.SqlClient">
                 ...
                 <td style="height: 36px">
                        ...
                        <td style="height: 36px" colspan="3" >             
                       <asp:TextBox ID="txtboxAbrivatedTitle" runat="server"   Width="600px" Enabled="false" ></asp:TextBox>
      ...
      <asp:TextBox ID="txtboxImpactfactor" runat="server"  Width="200px"></asp:TextBox> 
       ...
       <tr>
          ...
          <asp:TextBox ID="txtActiveyear" Text="Select Year" runat="server" CssClass="txtbox" OnTextChanged="txtActiveyear_TextChanged" AutoPostBack="true"
                ...
                <asp:Panel ID="PnlActiveyear" runat="server" CssClass="PnlDesign" Width="126px" Visible="true" Enabled="false">
...
<asp:ListItem>2018</asp:ListItem>
     ...
     <table border="1" width="100%">
       <tr>
           <td>
<asp:Label ID="Label3" runat="server" Text="Impact Factor" Font-Bold="true" Visible="false" ></asp:Label>
           </td>
           <td colspan="5">
                 <asp:Button ID="ADDProjectOutcome" runat="server" Text="Add" OnClick="ADDProjectOutcome_Click" Visible="false" />
   ...
   <%-- <asp:TemplateField>
        <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Year">
             <ItemTemplate>
                 <asp:TextBox ID="txtYear" runat="server"  Enabled="true" Width="100px"></asp:TextBox>
                        
             </ItemTemplate>              
        </asp:TemplateField>
    <asp:TemplateField HeaderText = "Impact Factor: ">
<ItemTemplate>
<asp:TextBox ID="txtImpactFactor" Width="100px" runat="server" />
</ItemTemplate>

</asp:TemplateField>
      <asp:TemplateField HeaderText = "Five Year ImpactFactor: ">
<ItemTemplate>
<asp:TextBox ID="txtFiveYearImpactFactor" Width="100px" runat="server" />
</ItemTemplate>
