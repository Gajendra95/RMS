<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="IncentivePointView.aspx.cs" Inherits="Incentive_IncentivePointView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="EditUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel2" runat="server" Font-Bold="true" Style="background-color: #E0EBAD" ForeColor="Black">
                <br />
                <center>
                    <table runat="server" id="table" visible="false">
                        <tr>
            ...
            <br />
            <br />
            <asp:Panel ID="Panel5" runat="server" Font-Bold="true" Style="background-color: #E0EBAD" ForeColor="Black" Visible="false" Height="280px">
                ...
                <center>
                    ...
                    <br />
                    <div id="div2" runat="server" style="overflow: scroll; height: 210px;">
                    ...
                    <div id="div3" runat="server" style="overflow: scroll; height: 216px;">
                        <asp:GridView ID="GridViewPRAISE" runat="server" AutoGenerateColumns="False" OnRowCreated="grvMergeHeader_RowCreated1" Visible="true"  OnRowDataBound="GridView5_RowDataBound2" DataSourceID="SqlDataSource1" EmptyDataText="PRAISE articles are not found" Width="800px">
                            ...
                            <Columns>
                                <asp:BoundField DataField="ReferenceNumber" HeaderText="Publication Id" HeaderStyle-Wrap="false"  SortExpression="ReferenceNumber"  ItemStyle-Wrap="false" ItemStyle-Width="10%"/>
                                <asp:BoundField DataField="TitleWorkItem" HeaderText="Title" SortExpression="TitleWorkItem" HeaderStyle-Wrap="false" ItemStyle-Wrap="true" ItemStyle-Width="80%"/>
                                 <asp:BoundField DataField="PublishMonthYear" HeaderText="Month&Year of Publication" SortExpression="PublishMonthYear" HeaderStyle-Wrap="false" ItemStyle-Wrap="true" ItemStyle-Width="80%" DataFormatString="{0:MM}" />
                                <asp:BoundField DataField="MUCategorization" HeaderText="Publication Category" HeaderStyle-Wrap="false"  SortExpression="MUCategorization" ItemStyle-Wrap="false" ItemStyle-Width="10%" />
                                <asp:BoundField DataField="Points" HeaderText="Points" ReadOnly="True" HeaderStyle-Wrap="false"  SortExpression="Points" ItemStyle-Wrap="false" ItemStyle-Width="20%" />
                            </Columns>
                        </asp:GridView>
            ...
            <br />
            <asp:Panel ID="PanelPatent" runat="server" Font-Bold="true" Style="background-color: #E0EBAD" ForeColor="Black" Visible="false">
                  <center>
                    <table>
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Patent Wise Points" Visible="true"></asp:Label></td>
                        </tr>

                    </table>
                    <br />
                    <div id="div4" runat="server" style="overflow: scroll; height: 216px;">
                         <asp:GridView ID="GridView2"  runat="server"  AutoGenerateColumns="False"   Visible="true" OnRowDataBound="GridView2_RowDataBound" DataSourceID="SqlDataSource6" EmptyDataText="NO Data found" Width="800px">
                            <AlternatingRowStyle BackColor="White" />
                            <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                            <HeaderStyle BackColor="#0b532d" Font-Bold="True" ForeColor="White" />
                            <PagerStyle ForeColor="#000000" HorizontalAlign="Center" />
                            ...
                            <SortedDescendingHeaderStyle BackColor="#93451F" />
                            <Columns>
                                <asp:BoundField DataField="ReferenceNumber" HeaderText="Patent Id" HeaderStyle-Wrap="false"  SortExpression="ReferenceNumber"  ItemStyle-Wrap="false" ItemStyle-Width="10%"/>
                                <asp:BoundField DataField="Title" HeaderText="Title" SortExpression="TitleWorkItem" HeaderStyle-Wrap="false" ItemStyle-Wrap="true" ItemStyle-Width="80%"/>
                                <asp:BoundField DataField="Grant_Date" HeaderText="Grant Date" HeaderStyle-Wrap="false"  SortExpression="Grant_Date" ItemStyle-Wrap="false" ItemStyle-Width="10%" DataFormatString="{0:d}" />
                                <asp:BoundField DataField="Points" HeaderText="Points" ReadOnly="True" HeaderStyle-Wrap="false"  SortExpression="Points" ItemStyle-Wrap="false" ItemStyle-Width="20%" />
                            </Columns>
                        </asp:GridView>
                        <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" SelectCommand="SELECT ReferenceNumber,Title,Grant_Date, sum(a.TotalPoint) as Points FROM Member_Incentive_Point_Transaction a INNER JOIN Patent_Data b ON a.ReferenceNumber=b.ID and  MemberId=@MemberId GROUP BY a.ReferenceNumber,Title,Grant_Date">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="txtEmployeecode" Name="MemberId" PropertyName="Text" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        </div>
                      <asp:Button ID="Button2Export" runat="server" Text="Excel Export"   OnClick="Button2Export_Click" />
                        </center>
  ...
  <asp:PostBackTrigger ControlID="Button2Export" />
        </Triggers>
    </asp:UpdatePanel>
