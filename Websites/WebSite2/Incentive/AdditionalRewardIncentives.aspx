<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="AdditionalRewardIncentives.aspx.cs" Inherits="Incentive_AdditionalRewardIncentives" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <asp:Label ID="lablPanelTitle" runat="server" Text="ARI Point Entry" Font-Bold="true"></asp:Label></center>
    <br />
    <br />
        ...
        <ContentTemplate>
                    ...
                    <center>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList RepeatDirection="Horizontal" runat="server" ID="ChkTypeOfPublication" AutoPostBack="true" OnSelectedIndexChanged="PublicationTypeChanged">
                                        <asp:ListItem Value="1" Selected="True">Publication</asp:ListItem>
                                        <%--  <asp:ListItem Value="2" Visible="false">Patent</asp:ListItem>--%>
            ...
            <asp:Panel ID="panelJournalArticle" runat="server" GroupingText="Journal Publish Details" Enabled="false" Visible="false" ForeColor="Black" Style="background-color: #E0EBAD">
                ...
                <center><asp:Label ID="lblNote" runat="server" Text="" ForeColor="Maroon" Font-Bold="true" Visible="false"></asp:Label></center>
                   <center><asp:Label ID="lblARINote" runat="server" Text="" ForeColor="Maroon" Font-Bold="true" Visible="false"></asp:Label></center>
                <table>
                <tr>
                    <td style="height: 36px; font-weight: normal">
                    ...
                    <asp:GridView ID="Grid_AuthorEntry" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Type">
                                ...
                                <ItemTemplate>
                                    <asp:DropDownList ID="DropdownMuNonMu" runat="server" Width="90" Enabled="false">
                            ...
                            <asp:TemplateField HeaderText="Base Point" Visible="false">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtBasePoint" runat="server" Width="80" onChange="onchangebasepoint(this,event)" ></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="ARI Point">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtARIPoint" runat="server" Width="100" Enabled="true" onChange="onchangeARIpoint(this)" AutoPostBack="true"></asp:TextBox>
                                    <asp:RegularExpressionValidator Display="None" ID="regexp2" runat="server"
                                        ControlToValidate="txtARIPoint" ValidationGroup="validation" ErrorMessage="ARI Point-Only two didgits are allowed after decimal"
                                        ValidationExpression="\d+(?:(?:\.|,)\d{1,2})?" />
                                </ItemTemplate>
                            </asp:TemplateField>
