<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="IncentivePointEntry.aspx.cs" Inherits="Incentive_IncentivePointEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        <asp:Label ID="lablPanelTitle" runat="server" Text="Incentive Point Entry" Font-Bold="true"></asp:Label></center>
    <br />
    <br />
                    ...
                    <center>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList RepeatDirection="Horizontal" runat="server" ID="radioincentive" AutoPostBack="true" OnSelectedIndexChanged="PublicationTypeChanged">
            ...
            <asp:Panel ID="panelJournalArticle" runat="server" GroupingText="Journal Publish Details" Enabled="false" Visible="false" ForeColor="Black" Style="background-color: #E0EBAD">
                ...
                <center><asp:Label ID="lblNote" runat="server" Text="" ForeColor="Maroon" Font-Bold="true" Visible="false"></asp:Label></center>
                 ...
                 <center><asp:Label ID="Label5" runat="server" Text="" ForeColor="Maroon" Font-Bold="true" Visible="false"></asp:Label></center>
                  <center><asp:Label ID="LabelQ" runat="server" Text="" ForeColor="Maroon" Font-Bold="true" Visible="false"></asp:Label></center>
                <table>
                <tr>
                    <td style="height: 36px; font-weight: normal">
