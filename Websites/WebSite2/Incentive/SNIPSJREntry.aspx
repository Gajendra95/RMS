<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="SNIPSJREntry.aspx.cs" Inherits="Incentive_SNIPSJREntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <asp:Label ID="lablPanelTitle" runat="server" Text="SNIP/SJR Point Entry" Font-Bold="true"></asp:Label></center>
    <br />
    <br />
    <asp:UpdatePanel ID="EditUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="panAddAuthor" runat="server" GroupingText="Author Details" Visible="false" ForeColor="Black" Style="background-color: #E0EBAD">
                ...
                <br />
                <center>
                    <asp:Label ID="lblnoteQuartile" runat="server" Text="" ForeColor="Maroon" Font-Bold="true" Visible="false"></asp:Label>
                </center>
                <br />
                    ...
                    <asp:GridView ID="Grid_AuthorEntry" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SNIP/SJR Point">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtSNIPSJRPoint" runat="server" Width="100" Enabled="true" onChange="onchangeSJRpoint(this)" AutoPostBack="true"></asp:TextBox>
