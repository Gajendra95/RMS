<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantEntryView.aspx.cs" Inherits="GrantEntry_GrantEntryView" %>
     ...
     function Confirm() {
         ...
         <script type="text/javascript">
             ...
             if (loc.match(/.*#/)) {
                 ...
                 window.location = loc + 'commentpopupoutcome';
             }
             else {
                 window.location = loc + '#commentpopupoutcome';
             }
...
<script language="javascript" type="text/javascript">
    function CalculateAmount1(txtBdlsClientID, txtPcsClientID, lblBdlCtClientID) {
     ...
     <div style="margin-top:-30px;float:right;margin-right:140px" >
         
         <asp:Button ID="BtnBack" runat="server" style="height: 26px" OnClick="BakButtonClick" Text="Back" />
         </div>
<asp:ScriptManager ID="Scriptmanager1" runat="server"/>
 ...
 <table  style="width: 92%">
   <%--  <tr>
            <td>
 <u><asp:LinkButton ID="LinkOutcome" runat="server"  Style="float:right;font-size:medium;font-weight:bold" ForeColor="Blue" onclick="LinkButton1_Click">View Outcome Details</asp:LinkButton> </u>
                      <asp:HiddenField ID="Outcome" runat="server"   />
                 <asp:ModalPopupExtender ID="ModalPopupExtenderoutcome" runat="server" TargetControlID="LinkOutcome" PopupControlID="paneloutcome"
     ...
     <tr> 
         <td style="height: 36px; font-weight:normal; color:Black">
           ...
           <td style="height: 36px">
            ...
            <%-- <td>&nbsp;</td>
        <td><asp:Button ID="BtnBack" runat="server" style="height: 26px"
                                 OnClick="BakButtonClick" Text="Back" /></td>--%>
...
<asp:Panel ID="MainpanelGrant" runat="server" Enabled="false" GroupingText="Basic Details" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD; margin-bottom: 0px;"  > 
 ...
 <td class="auto-style94">
     <asp:TextBox ID="TextBoxUTN" runat="server" Enabled="false" Width="150px"></asp:TextBox>
                              
 </td>
          <td class="auto-style71">
 
   <asp:Label ID="LabelEnteredBy" runat="server" Text="Entered By" ForeColor="Black"></asp:Label>
                    
 </td>
 <td class="auto-style94">
     <asp:TextBox ID="TextBoxEnteredBy" runat="server" Enabled="false" Width="150px"></asp:TextBox>
...
<td>
  ...
  <%--<td>
    <asp:Label ID="Label14" runat="server" Text="Actual Applied Date" ForeColor="Black"></asp:Label>
    </td> 
...
<td> <asp:TextBox ID="TextBoxGrantAmt" runat="server" Width="150px" style="margin-left: 0px" ></asp:TextBox></td>
     ...
     <asp:ListItem Value="N">No</asp:ListItem>
      ...
      <td>
         <asp:Label ID="Label2" runat="server" Text="Contact Number"> </asp:Label>
              ...
              <td class="auto-style86"><asp:TextBox ID="txtcontact" runat="server" MaxLength="12" Width="200px"></asp:TextBox>
     </td>
 ...
 <td class="auto-style98">
     <asp:DropDownList ID="DropDownListSourceGrant" runat="server" DataSourceID="SqlDataSourceDropDownListSourceGrant" DataTextField="SourceName" DataValueField="SourceId" Enabled="true" Height="20px" Width="150px" ></asp:DropDownList>
      ...
      <td class="auto-style65">   <asp:Label ID="Label15" runat="server" Text="Duration Of The Project(in months)" ForeColor="Black"></asp:Label>
</td>
...
<td class="auto-style95">
 ...
 <td colspan="4" class="auto-style64">
    ...
    <asp:Label ID="lblRevisedAppliedAmt" runat="server" Text="Sanction Amount" ForeColor="Black" Visible="true" ></asp:Label>
</td>
<td> <asp:TextBox ID="txtRevisedAppliedAmt" runat="server" Width="200px" style="margin-left: 0px"  Visible="true"></asp:TextBox> </td>
<td  class="style74"> 
...
<asp:TextBox ID="Textsanctionorderdate" runat="server" Enabled="true" Width="150px" Height="16px" AutoPostBack="true" Visible="false" ></asp:TextBox>
          ...
          <td >
 <u><asp:LinkButton ID="LinkOutcome" runat="server"  Style="float:right;font-size:medium;font-weight:bold"  onclick="LinkButton1_Click">View Outcome Details</asp:LinkButton> </u>
                      <asp:HiddenField ID="Outcome" runat="server"   />
                 <asp:ModalPopupExtender ID="ModalPopupExtenderoutcome" runat="server" TargetControlID="LinkOutcome" PopupControlID="paneloutcome"
                    BackgroundCssClass="modelBackground" ></asp:ModalPopupExtender>
                   </td>
...
<td class="auto-style19">
 ...
 <br />
    ...
    <asp:Panel ID="panAddAuthor" runat="server" GroupingText="Investigator Details"  ForeColor="Black" Enabled="false" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"  > 
...
<br />
    ...
    <br />
    <asp:Button ID="LinkButton1" runat="server" Text="Instructions to enter  Percentage sharing" />
...
<%--     <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/srchImg.gif" CssClass="blnkImgCSS" />
  ...
  <SelectParameters>
    ...
    <%-- <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/srchImg.gif" CssClass="blnkImgCSS" />
         ...
         <ItemTemplate>
        <asp:TextBox ID="PercentageIO" runat="server" Width="150"  AutoPostBack="true"></asp:TextBox> 
...
<asp:Panel ID="Panel4" runat="server"   Width="1000px" GroupingText="Inter Mahe Institute" >
  ...
  <SelectParameters>
     ...
     <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/srchImg.gif" CssClass="blnkImgCSS" />
           ...
           <asp:TemplateField HeaderText="Sharing Amount( in %)">
         <ItemTemplate>
        <asp:TextBox ID="PercentageII" runat="server" Width="150"  AutoPostBack="true" > </asp:TextBox> 
...
<table style="width: 100%">
 ...
 <td class="auto-style50">
     <asp:TextBox ID="TextBoxProjectCommencementDate" runat="server" Width="120px" Enabled="false" ></asp:TextBox>
 ...
 <td class="auto-style50">
     <asp:TextBox ID="TextBoxProjectCloseDate" runat="server"   Width="120px" Enabled="false" ></asp:TextBox>
...
<%--                 <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="None"  ControlToValidate="TextBoxProjectCloseDate" ValidationGroup="validation"
 ...
 <td class="auto-style50">
     <asp:TextBox ID="TextBoxExtendedDate" runat="server"   Width="120px" Enabled="false"  ></asp:TextBox>
 ...
 <td class="auto-style51">
     <asp:TextBox ID="txtNoOFSanctions" runat="server"  Width="120px" AutoPostBack="true" Enabled="false"  ></asp:TextBox>
                              
 </td>
  <td class="auto-style56">Service Tax Applicable</td>
          <td class="auto-style57" >  <asp:DropDownList ID="DropDownList2" runat="server" Enabled="false" Width="100px">
 ...
 <td> <asp:Label runat="server" ID="lblnote" Visible="false" Text=" Note: Sanction details entered by finance users only"></asp:Label></td>
     ...
     <Columns>     
         ...
         <ItemTemplate>
             <asp:TextBox ID="txtsanctionNo" Enabled="false" runat="server" Width="120px"  ></asp:TextBox>     
             </ItemTemplate>              
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Sanction date">
             <ItemTemplate>
                 <asp:TextBox ID="txtSanctiondate" Enabled="false" runat="server"   Width="130px" ></asp:TextBox>
           <asp:CalendarExtender ID="CalendarExtender1" runat="server"
...
<asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" Display="None"  ControlToValidate="txtSanctiondate" ValidationGroup="validation"
        ...
        <asp:TemplateField HeaderText="Capital Amount" >
             <ItemTemplate>
                 <asp:TextBox ID="txtsancapitalAmount" Enabled="false" runat="server"   Width="150px"></asp:TextBox>                
           ...
           <asp:TemplateField HeaderText="Operating Amount">
             <ItemTemplate>
                 <asp:TextBox ID="txtSanOpeAmt" runat="server" Enabled="false" Width="130px"   ></asp:TextBox>
  ...
  <asp:Button ID="dummybutton" runat="server" Style="display: none" />
    ...
    <asp:ModalPopupExtender ID="ModalPopupExtenderOPAmount" runat="server" TargetControlID="dummybutton" PopupControlID="PanelOPAmount"
          ...
          <asp:TemplateField HeaderText="Total Amount">
             <ItemTemplate>
                     <asp:TextBox ID="txtsantotalAmount" Enabled="false" runat="server"   Width="100px" ></asp:TextBox>         
              </ItemTemplate>              
        </asp:TemplateField>
       
        <asp:TemplateField HeaderText = "Narration">
<ItemTemplate>
<asp:TextBox ID="txtNarration" Width="255px"  Enabled="false" runat="server" />
</ItemTemplate>
</asp:TemplateField>
...
<asp:Panel ID="Panel1" runat="server" >
 <table width="92%">
     ...
     <asp:GridView ID="GridView_bank" runat="server" Enabled="false" OnRowDataBound="RowDataBoundBank" AutoGenerateColumns="False"    CellPadding="2" ForeColor="#333333" >
...
<ItemTemplate>
<center>
<asp:DropDownList ID="ddlSanctionEntryNo" runat="server" Enabled="false"  />
  </center>          
</ItemTemplate>      
</asp:TemplateField>  
         ...
         <asp:TemplateField HeaderText="Currency">
             <ItemTemplate>
                 <asp:DropDownList ID="CurrencyCode" Enabled="false" runat="server" DataSourceID="SqlDataSourceCurrency" DataTextField="Code" Width="50px"  DataValueField="Code">
         ...
         <ItemTemplate> 
            <asp:DropDownList ID="ModeOfRecevie" runat="server"  Enabled="false" DataSourceID="SqlDataSourceModeOfRec" DataTextField="RefName" Width="100px"  DataValueField="RefType">
  </asp:DropDownList>
   ...
   SelectCommand="select RefType, RefName from Mode_Recevie_M">     
        ...
        <asp:TemplateField HeaderText="Reccieved Date">
             <ItemTemplate>
                 <asp:TextBox ID="ReceviedDate" runat="server"  Enabled="false" Width="80px" ></asp:TextBox>
           <asp:CalendarExtender ID="CalendarExtender1" runat="server"
...
<%-- <asp:Image ID="ImageRecevieddate" runat="server" ImageUrl="~/Images/srchImg.gif" CssClass="blnkImgCSS" />--%>
 <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" Display="None"  ControlToValidate="Recevieddate" ValidationGroup="validation"
         ...
         <ItemTemplate>
             <asp:TextBox ID="ReceviedAmount" runat="server" Width="80px" Enabled="false" ></asp:TextBox>     
             </ItemTemplate>              
        </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="INR Equivalent">
             <ItemTemplate>
                 <asp:TextBox ID="ReceviedINR" runat="server" Width="100px" Enabled="false"  ></asp:TextBox>
          
             </ItemTemplate>              
        </asp:TemplateField>
          <asp:TemplateField HeaderText="TDS">
             <ItemTemplate>
                 <asp:TextBox ID="TDS" runat="server" Width="50px" Enabled="false"  ></asp:TextBox>          
             </ItemTemplate>              
        </asp:TemplateField>
            <asp:TemplateField HeaderText="Reference No">
             <ItemTemplate>
                 <asp:TextBox ID="ReferenceNo" runat="server" Width="50px" Enabled="false"  ></asp:TextBox>          
             </ItemTemplate>              
        </asp:TemplateField>
 ...
 <asp:TemplateField HeaderText="Received Bank" Visible="false" >
  ...
  <ItemTemplate>
  <asp:TextBox ID="ReceivedBankId" runat="server" Visible="false" Enabled="false"></asp:TextBox>
 </ItemTemplate>            
   </asp:TemplateField>
          <asp:TemplateField Visible="false">
  <ItemTemplate>
  <asp:TextBox ID="CreditedBankId" runat="server" Visible="false" Enabled="false"></asp:TextBox>
 </ItemTemplate>            
   </asp:TemplateField>
   <asp:TemplateField Visible="false">
  <ItemTemplate>
  <asp:TextBox ID="BankId" runat="server" Visible="false" Enabled="false"></asp:TextBox>
 </ItemTemplate>            
   </asp:TemplateField>
   <asp:TemplateField HeaderText = "Narration" >
<ItemTemplate>
...
<asp:TextBox ID="txtincentivedate" runat="server" Width="155px"  />
    <asp:CalendarExtender ID="CalendarExtender5" runat="server"
                TargetControlID="txtincentivedate" PopupButtonID="txtincentivedate" Enabled="false"  Format="dd/MM/yyyy" >
</asp:CalendarExtender>
</ItemTemplate>      
</asp:TemplateField> 
...
<center></center>
 ...
 <asp:Panel ID="PanelOverhead" runat="server"  Visible="false" Enabled="false" GroupingText="Overhead details" ForeColor="Black" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"   > 
...
<asp:Panel ID="PanelUploaddetails" runat="server" GroupingText="Uploaded Files"   ForeColor="Black" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"   Visible="false"  >
    ...
    <asp:Label ID="lblUser" runat="server" Visible="false" Text='<%# Eval("CreatedBy") %>'></asp:Label>
        ...
        <br />
        <asp:Panel ID="PanelFinanceClosure"  Visible="false" Enabled="false" runat="server" GroupingText="Finance Status Closure" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD" Height="95px" >
                   <table>
              <tr>
   ...
   <tr>
     <td style="height: 36px; font-weight:normal">
      <asp:Label ID="Labelrem" runat="server" Text="Remarks"  ></asp:Label>
       ...
       <asp:Panel ID="panelReject" runat="server" Visible="false" GroupingText="Remarks for Rejection" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"  > 
 <table style="width: 92%">
   <tr>
     <td style="height: 36px; font-weight:normal">
      <asp:Label ID="Label10" runat="server" Text="Remarks"  ></asp:Label>
        ...
        <td style="height: 36px">
          <asp:TextBox ID="txtReject" runat="server" TextMode="MultiLine" Style="border-style:inset none none inset;" Enabled="false"
        Width="900px" ></asp:TextBox>   
       </td>
     </tr>
</table>
</asp:Panel>
 <asp:Panel ID="panelCanelRemarks" runat="server" Visible="false" GroupingText="Remarks for cancellation" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"  > 
 <table style="width: 92%">
   <tr>
     <td style="height: 36px; font-weight:normal">
...
<asp:Panel ID="PanelAmount" runat="server" GroupingText="Incentive Add" CssClass="modelPopup"  Visible="false" Style="font-weight:bold; background-color:#E0EBAD; margin-top: 9px;" >
...
<asp:TextBox ID="txtOPAmount" runat="server" Enabled="true"  Text='<%# Bind("Amount") %>'/>
    ...
    <PagerStyle BackColor="#000000" ForeColor="#000000" HorizontalAlign="Center" />
     ...
     <asp:Panel ID="panelpopuptest" runat="server" width="800px" CssClass="modelPopup" Style="display:none" BackColor="GhostWhite" >
...
4.Percentage sharing is based on sanctioned applied amount.
         ...
         <br />
       <center>   <asp:Button ID="Button16" runat="server" Text="Exit"  /></center>
         <br />
         <br />
    </asp:Panel>
         ...
         <asp:Panel ID="paneloutcome"  runat="server"  width="800px" CssClass="modelPopup" Style="display:none" BackColor="GhostWhite"  >
...
<asp:Label ID="Label16" runat="server" Text="Patents Details" Font-Size="20px" Style="color:black" />
     ...
     <asp:GridView ID="GridViewPatentOutcome" runat="server" AllowSorting="true" AutoGenerateColumns="false" EmptyDataText="No Data found"
        OnRowDataBound="GridViewProject_RowDataBound" DataSourceID="SqlDataSourcepatentoutcome" >
...
<asp:Label ID="Label17" runat="server" Text="Project Outcome Details" Font-Size="20px" Style="color:black" />
     ...
     <asp:GridView ID="GridViewprojecout" runat="server" AllowSorting="true" AutoGenerateColumns="false" EmptyDataText="No Data found"
        OnRowDataBound="GridViewProject_RowDataBound" DataSourceID="SqlDataSourceprooutcome" >
...
<br />
           ...
           <asp:Button ID="btnoutcomeexit" runat="server" Text="EXIT" />
