<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="SeedMoneyCancellation.aspx.cs" Inherits="GrantEntry_SeedMoneyCancellation" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <style type="text/css">
     ...
     <center> <asp:Label ID="lablPanelTitle" runat="server" Text="Seed Money For Faculty Research" Font-Bold="true"  ></asp:Label></center>
     <center> <asp:Label ID="lblfacultyapp" runat="server" Text="Seed Money Approval For Faculty Research" Font-Bold="true" Visible="false"  ></asp:Label></center>
     <center> <asp:Label ID="lblstudentapp" runat="server" Text="Seed Money Approval For student Research" Font-Bold="true"  Visible="false"  ></asp:Label></center>
            <br />
...
and SISInstnHR.Institute_Id=SISInstitution.InstID and SISInstnHR.Institute_Id=SISStudentGenInfo.InstID" ProviderName="System.Data.SqlClient">
         ...
         <table width="100%">
             <tr>
              ...
              <td colspan="3" class="auto-style20">
                 <asp:TextBox ID="txtComments" runat="server" Width="700px" TextMode="MultiLine"></asp:TextBox>
                
             </td>
             </tr>
         </table>
     </asp:Panel>
     <asp:Panel ID="Panel3" runat="server" GroupingText="Cancel Comments"  ForeColor="Black"  Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"  > 
         <table width="100%">
             <tr>
                 <td class="auto-style50">
   ...
   <table width="100%">
    <tr>
<td align="center">
 <asp:Button ID="BtnCancel" runat="server" Text="Cancel" OnClick="BtnCancel_Click"  CausesValidation="true" Visible="false"  ></asp:Button>
</td>
 </tr>
</table>
          </asp:Panel>
