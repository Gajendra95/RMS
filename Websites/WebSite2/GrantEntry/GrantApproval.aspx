<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantApproval.aspx.cs" Inherits="GrantEntry_GrantApproval" %>
 ...
 <td class="auto-style60">
     <asp:DropDownList ID="DropDownListProjStatus" runat="server" Width="150px"   DataSourceID="SqlDataSourcePrjStatus" DataTextField="StatusName" DataValueField="StatusId"   AutoPostBack="true" Height="20px"></asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSourcePrjStatus" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
           SelectCommand="select StatusId,StatusName from Status_Project_M">
 </asp:SqlDataSource>                        
 </td>
...
<td  class="style74"> 
     <asp:Label ID="lblsanctionorderdate" runat="server" Text="Sanction Ordered Date" ForeColor="Black" Visible="true" ></asp:Label>
</td>
         <td>
<asp:TextBox ID="Textsanctionorderdate" runat="server" Enabled="true" Width="150px" Height="16px" AutoPostBack="true" Visible="true" ></asp:TextBox>
...
<asp:TemplateField HeaderText="Recieved Date">
 ...
 <asp:TextBox ID="INREquivalent" runat="server" ></asp:TextBox>               
  ...
  <asp:Panel ID="PanelUploaddetails" runat="server"  ForeColor="Black" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"   Visible="true"  >
        <%--  <div style="margin-left:450px; margin-top:20px; position:absolute ">
         ...
         <td align="center">
             <asp:Panel ID="PanelViewUplodedfiles" runat="server" ForeColor="Black" 
                 GroupingText=" Uploaded files" Visible="true" Width="1000px">
                 <asp:GridView ID="GVViewFile" runat="server" AutoGenerateColumns="False" OnRowDataBound="GVViewFile_RowDataBound"
                     ...
                     HeaderStyle-ForeColor="White"  onselectedindexchanged="GVViewFile_SelectedIndexChanged" 
    ...
    <asp:Label ID="lblUser" runat="server" Visible="false" Text='<%# Eval("CreatedBy") %>'></asp:Label>
        ...
        <br />
      <asp:Panel ID="panelReowrkRemarks" runat="server" Visible="true" Style="font-weight:bold; border-style:groove;background-color:#E0EBAD" GroupingText="Remarks for Rework"  > 
 <table style="width: 92%">
   <tr>
...
<td align="center">
 ...
 <asp:Button ID="BtnSanction" runat="server" Text="Approve" OnClick="BtnSanction_Click" Enabled="false" ></asp:Button>
