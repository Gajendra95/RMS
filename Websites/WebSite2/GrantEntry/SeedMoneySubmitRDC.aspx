<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="SeedMoneySubmitRDC.aspx.cs" Inherits="GrantEntry_SeedMoneySubmitRDC" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <style type="text/css">
     ...
     <center> <asp:Label ID="lblfacultyapp" runat="server" Text="Seed Money submit For Faculty/Student Research" Font-Bold="true" Visible="false"  ></asp:Label></center>
...
<td align="center">
 <%-- <asp:Button ID="BtnSave" runat="server" Text="Save" OnClick="BtnSave_Click"  CausesValidation="true" ValidationGroup="validation" Visible="false"  ></asp:Button>--%>
    <asp:Button ID="BtnSubmit" runat="server" Text="Save/Submit" OnClick="BtnSubmit_Click" CausesValidation="true" Visible="false" ></asp:Button>
