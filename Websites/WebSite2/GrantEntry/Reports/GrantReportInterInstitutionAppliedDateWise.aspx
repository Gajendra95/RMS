<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantReportInterInstitutionAppliedDateWise.aspx.cs" Inherits="GrantEntry_Reports_GrantReportInterInstitutionAppliedDateWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <b><asp:Label runat="server" ID="lblTitle" Text="Project Details-Inter Institute Applied Date Wise"></asp:Label></b>
        <br />
    </center>
