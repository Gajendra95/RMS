<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantReportInterInstitutionCreatedDateWise.aspx.cs" Inherits="GrantEntry_Reports_GrantReportInterInstitutionCreatedDateWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <b><asp:Label runat="server" ID="lblTitle" Text="Project Details-Inter Institute Entry Date Wise"></asp:Label></b>
        <br />
    </center>
