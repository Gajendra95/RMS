<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantReportTypeWise.aspx.cs" Inherits="GrantEntry_Reports_GrantReportTypeWise" %>
...
<center>
<b><asp:Label runat="server" ID="lblTitle" Text="Project Details-ProjectTypewise"></asp:Label>
    </b>
<br />
</center>
...
<td><asp:Button id="Buttonback" runat="server" Text="Back" OnClick="backClick" CausesValidation="false"/></td></tr>
</table>
<br />
...
<asp:SqlDataSource ID="SqlDataSourceProjectStatusType" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
                   SelectCommand="select StatusId,StatusName from Status_Project_M where StatusId!='CAN'" >
</asp:SqlDataSource>
</td>
<td rowspan="2">
