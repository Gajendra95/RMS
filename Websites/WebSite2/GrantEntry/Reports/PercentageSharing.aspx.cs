...
public partial class GrantEntry_Reports_PercentageSharing : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Percentage Sharing details(Created Date Wise)";
        }
    }
    ...
    protected void viewclick(object sender, EventArgs e)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = "/PublicationReports/ProjectPercentageSharing";
        ...
        ReportParameter FundSharingType = new ReportParameter("FundSharingType", ddlFundSharingType.SelectedValue);
        ReportParameter[] p = { p22, p3, FundSharingType };
