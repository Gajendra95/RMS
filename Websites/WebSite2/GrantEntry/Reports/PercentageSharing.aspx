<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PercentageSharing.aspx.cs" Inherits="GrantEntry_Reports_PercentageSharing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        <b>
            <asp:Label runat="server" ID="lblTitle" Text="Project Details-ProjectTypewise"></asp:Label>
        </b>
        <br />
    </center>
        ...
        <table border="1">
            <tr>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="None" ControlToValidate="TextBoxToDate" ValidationGroup="validation"
                  ...
                  <td style="height: 56px; font-weight: normal">
                    <asp:Label ID="Label3" runat="server" Text="Fund Sharing type " ForeColor="Black"  ></asp:Label>

<asp:DropDownList ID="ddlFundSharingType" runat="server" Style="border-style:inset none none inset;"  AppendDataBoundItems="true">  
<asp:ListItem Value="B">Both </asp:ListItem>
<asp:ListItem Value="I">Inter MAHE Sharing </asp:ListItem>
<asp:ListItem Value="E">Inter Organization Sharing</asp:ListItem>
</asp:DropDownList> 
                </td>
                <td rowspan="2">
