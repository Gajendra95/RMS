<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="SeedMoneyReportFaculty.aspx.cs" Inherits="GrantEntry_Reports_SeedMoneyReportFaculty" %>
...
<center>
<b>Faculty Seed Money Details</b>
</center>
...
<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="None"  ControlToValidate="TextBoxToDate" ValidationGroup="validation"
 ...
 <asp:DropDownList ID="ddlStatus" runat="server" Style="border-style:inset none none inset;" AppendDataBoundItems="true" DataSourceID="SqlDataSource1" 
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
         ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
         SelectCommand="SELECT * FROM Status_Seedmoney_M where StatusId='SUB' or  StatusId='NEW' or  StatusId='APP' or StatusId='REJ' or  StatusId='REW' or  StatusId='REV'"></asp:SqlDataSource>
 </td>
  <td rowspan="2">
