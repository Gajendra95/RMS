<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantEntryCancellation.aspx.cs" Inherits="GrantEntry_GrantEntryCancellation" %>
   ...
   <tr>
     <td style="height: 36px; font-weight:normal">
      <asp:Label ID="Label13" runat="server" Text="Remarks"  ></asp:Label>
        ...
        <td style="height: 36px">
          <asp:TextBox ID="TextBoxRemarks" runat="server" TextMode="MultiLine" Style="border-style:inset none none inset;" Enabled="true"
...
<table width="100%">
    <tr>
<td align="center">
  <asp:Button ID="btnSave" runat="server" Text="Cancel" OnClick="BtnSave_Click"  CausesValidation="true" ValidationGroup="validation" ></asp:Button>
