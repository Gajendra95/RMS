...
public partial class GrantEntry_Seedmoneydetails : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
         if (Session["Role"].ToString() == "2") 
            ...
            else
            {
                ...
                string EntryType = "F";
                a = b.getSeedMoneyActiveStatus(EntryType, txtdate.Text);
                Session["Seedmoneycycleid"] = a.id.ToString();
                if (a.id == 0)
                {
                    ...
                    lblNote.Text = "Note - Reception of application for Seed money proposal for this quarter is closed.";
    ...
    private void dataBind()
    {
        ...
        string role = Session["Role"].ToString();
         ...
         if (role == "2")
         {
             ...
             {
                 SqlDataSource1.SelectCommand = " select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType  from SeedMoneyDetails s, Status_Seedmoney_M p where  (s.Status='SUB' or s.Status='REV') and s.Status=p.StatusId order by ID";
             }
             else if (txtSid.Text != "" && txtstitle.Text == "")
             {
                 ...
                 SqlDataSource1.SelectCommand = " select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType  from SeedMoneyDetails s, Status_Seedmoney_M p where  (s.Status='SUB' or s.Status='REV') and s.ID like'%' + @ID + '%' and s.Status=p.StatusId order by ID";
             }
             else if (txtSid.Text == "" && txtstitle.Text != "")
             {
                 SqlDataSource1.SelectParameters.Clear();
                 ...
                 SqlDataSource1.SelectCommand = "select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType  from SeedMoneyDetails s, Status_Seedmoney_M p where  (s.Status='SUB' or s.Status='REV') and s.Title like'%' + @Title + '%' and s.Status=p.StatusId order by ID";
             }
             else
             {
                 SqlDataSource1.SelectParameters.Clear();
                 ...
                 SqlDataSource1.SelectCommand = "select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType  from SeedMoneyDetails s, Status_Seedmoney_M p where  (s.Status='SUB' or s.Status='REV') and s.Title like'%' + @Title + '%' and s.ID like'%' + @ID + '%' and s.Status=p.StatusId order by ID";
             }
         ...
         else
         {
             if (SeedMoneyActive == "N")
             {
                 if (txtSid.Text == "" && txtstitle.Text == "")
                 {
                     ...
                     SqlDataSource1.SelectCommand = " select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType from SeedMoneyDetails s , Status_Seedmoney_M p where  Createdby='" + Session["UserId"].ToString() + "' and( s.Status='REW' ) and s.Status=p.StatusId order by ID";
                 }
                 else if (txtSid.Text != "" && txtstitle.Text == "")
                 {
                     SqlDataSource1.SelectParameters.Clear();
                 ...
                 else if (txtSid.Text == "" && txtstitle.Text != "")
                 {
                     ...
                     SqlDataSource1.SelectCommand = "select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType  from SeedMoneyDetails s, Status_Seedmoney_M p where  Createdby='" + Session["UserId"].ToString() + "' and( s.Status='REW') and s.Title like'%' + @Title + '%' and s.Status=p.StatusId order by ID";
                 }
                 else
                 {
                     SqlDataSource1.SelectParameters.Clear();
                     ...
                     SqlDataSource1.SelectCommand = "select s.ID,s.Title,s.Writeup,s.Budget,s.AppliedDate,p.StatusName,s.Createdby,s.CreatedDate,s.Institution,s.Department,s.EntryType  from SeedMoneyDetails s, Status_Seedmoney_M p where  Createdby='" + Session["UserId"].ToString() + "' and( s.Status='REW' ) and s.Title like'%' + @Title + '%' and s.ID like'%' + @ID + '%' and s.Status=p.StatusId order by ID";
                 }
                 GridViewSearchGrant.DataBind();
                 SqlDataSource1.DataBind();
                 BtnSave.Enabled = true;
             }
             else if (SeedMoneyActive == "Y")
                 {
