<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="Seedmoneydetails.aspx.cs" Inherits="GrantEntry_Seedmoneydetails" MaintainScrollPositionOnPostback="true" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="MAHE/Non MAHE">
                        <ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceAuthorType" runat="server" SelectCommand="select Id,type from Author_Type_M where Id='N'or Id='S'or Id='M' order by DisplayNumber asc " SelectCommandType="Text"
                                ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>"
