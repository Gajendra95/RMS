<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="SeedMoneyEdit.aspx.cs" Inherits="GrantEntry_SeedMoneyEdit" MaintainScrollPositionOnPostback="true" %>
   ...
   <asp:HiddenField ID="hiddenProjectType" runat="server" Value='<%# Eval("ProjectType") %>'/>
    ...
    <asp:Panel ID="panAddAuthor" runat="server" GroupingText="Investigator Details" ForeColor="Black" Style="font-weight: bold; border-style: inset; background-color: #E0EBAD" Enabled="false">
        ...
        <table width="92%">
            <tr>
                <td>
                    <asp:Button ID="BtnAddMU" runat="server" Text="Add New Investigator" OnClick="addRow" Visible="false" />
...
and SISInstnHR.Institute_Id=SISInstitution.InstID and SISInstnHR.Institute_Id=SISStudentGenInfo.InstID"
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="" ForeColor="Black" Style="font-weight: bold; border-style: inset; background-color: #E0EBAD">
        <table width="100%">
            <tr>
                <td align="center">
                    <asp:Button ID="BtnSaveUpdate" runat="server" Text="Save/Update" OnClick="BtnSaveUpdate_Click"  CausesValidation="true" ValidationGroup="validation" ></asp:Button>
