<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="SeedMoneyEntrybyRDC.aspx.cs" Inherits="GrantEntry_SeedMoneyEntrybyRDC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">  
    ...
    <%--<style type="text/css">
     ...
     <script type="text/javascript">
         ...
         function callthis1() {
             ...
             if (loc.match(/.*#/)) {
                 // loc = loc.substring(0,loc.length - 1);
                 window.location = loc + 'commentpopup1';
             }
             else {
                 window.location = loc + '#commentpopup1';
             }
    ...
    <center>
        <asp:Label ID="lablPanelTitle" runat="server" Text="Seed Money For Faculty Research" Font-Bold="true"></asp:Label></center>
    <center>
        <asp:Label ID="lblfacultyapp" runat="server" Text="Seed Money Approval For Faculty Research" Font-Bold="true" Visible="false"></asp:Label></center>
    <center>
        <asp:Label ID="lblstudentapp" runat="server" Text="Seed Money Approval For student Research" Font-Bold="true" Visible="false"></asp:Label></center>
    <br />
        ...
        <center>
            <table style="width: 92%">
                <tr>
                    ...
                    <td style="height: 36px; font-weight: normal; color: Black">ID
                    </td>
                    <td style="height: 36px">
                        <asp:TextBox ID="txtSid" runat="server" Style="border-style: inset none none inset;"></asp:TextBox>
                    </td>

                    <td style="height: 36px; font-weight: normal; color: Black">Title of the Project
                    </td>

                    <td>
                        <asp:TextBox ID="txtstitle" runat="server" Style="border-style: inset none none inset;" Width="340px"></asp:TextBox>
                    </td>
            ...
            <br />
            <asp:Label ID="lblNote" runat="server" Text="Note - Reception of application for Seed money proposal for this quarter is closed. Request you to apply for the next call during July 2019." ForeColor="Black" Visible="false"></asp:Label>
            <br />
   ...
   <asp:HiddenField ID="hiddenProjectType" runat="server" Value='<%# Eval("ProjectType") %>'/>
    ...
    <asp:Panel ID="panelSearchPub" runat="server" ForeColor="Black" GroupingText="New Proposal" Font-Bold="true" Style="background-color: #E0EBAD">
        <table width="100%">
             <tr>
                 <td >
                    <asp:Label ID="Label7" runat="server" Text="Seed Money Cycle" Visible="false"></asp:Label>
                </td>
                <td>
                     <div>
                      <asp:TextBox ID="IsAutoApproved" runat="server" Width="100px" OnTextChanged="IsAutoApproved_TextChanged" AutoPostBack="true" Enabled="false"></asp:TextBox>
                     <asp:ImageButton ID="ImageButtonSeed" runat="server" ImageUrl="~/Images/srchImg.gif" OnClientClick="setRow2(this)" OnClick="showPop2" />
                        </div>
                      <%--  <asp:ModalPopupExtender ID="ModalPopupExtenderSeed" runat="server" TargetControlID="ImageButtonSeed" PopupControlID="PanelseedMoney"
            ...
            <tr>
                ...
                <td class="auto-style51">
                    <asp:TextBox ID="txtdate" runat="server" Width="200px" Height="25px"></asp:TextBox>
        ...
        <asp:SqlDataSource ID="SqlDataSourceseedStatus" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
           SelectCommand="select StatusId,StatusName from Status_Seedmoney_M where StatusId='APP'or StatusId='REJ' or StatusId='REW' or StatusId='SUB' or StatusId='NEW'">
            ...
            <tr>
                <td class="auto-style53">
                    <asp:Label ID="lblAPPremarks" runat="server" Text="Approved Remarks" Visible="false"></asp:Label>
                </td>
                <td class="auto-style51">
            ...
            <%--<tr>
                 <td >
                    <asp:Label ID="Label7" runat="server" Text="Is Auto Approved"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="IsAutoApproved" runat="server" Width="75"  AutoPostBack="true" Enabled="false">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Author Name">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="EmployeeCodeBtn" runat="server" ImageUrl="~/Images/srchImg.gif" OnClientClick="setRow(this)" OnClick="showPop3" />

                           <%-- <asp:ModalPopupExtender ID="ModalPopupExtender4" runat="server" TargetControlID="EmployeeCodeBtn" PopupControlID="popup"
                                BackgroundCssClass="modelBackground">
                            </asp:ModalPopupExtender>--%>
                            <asp:ImageButton ID="ImageButton1" runat="server" Visible="false" ImageUrl="~/Images/srchImg.gif" OnClientClick="setRow(this)" OnClick="showPop4"/>
    ...
    <asp:Panel ID="PanelFileUpload" runat="server" GroupingText="File Upload" ForeColor="Black" Style="font-weight: bold; border-style: inset; background-color: #E0EBAD">
        ...
        <ContentTemplate>
            ...
            <tr>
                <td colspan="6">
                    <asp:Label ID="LabelNote2" runat="server" ForeColor="Black" Text="Upload only PDF files and the file size has to be less than or equal to 10MB." Font-Bold="true"> </asp:Label><br />
                </td>
            </tr>
        </table>
    </asp:Panel>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="" ForeColor="Black" Style="font-weight: bold; border-style: inset; background-color: #E0EBAD">
        <table width="100%">
            <tr>
                <td align="center">
                    ...
                    <%--<asp:Button ID="BtnApprove" runat="server" Text="Save/Approve" OnClick="BtnApprove_Click" CausesValidation="true" Visible="false"></asp:Button>
                    ...
                    <asp:Button ID="BtnRevision" runat="server" Text="Revision Required" OnClick="BtnRevision_Click" CausesValidation="true" Visible="false"></asp:Button>--%>
                </td>
            </tr>
        </table>
    </asp:Panel>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="IsAutoApproved" />
           
            <%-- <asp:PostBackTrigger ControlID="FileUploadPdf" />--%>
        </Triggers>
     </asp:UpdatePanel> 
    ...
    <br />
     <div id="commentpopup" class="overlay">
                <div class="popupp" style="width: 400px; height:200px;margin-top: 20px;">

                    <a class="close" href="#">&times;</a>
                    <div class="content" style="overflow-y: scroll; height: auto; width: 400px;">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
   <ContentTemplate> 
        <asp:Panel ID="PanelseedMoney" runat="server">
        <br />
        <br />
        <center>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="GridViewSeedMoney" />
        </Triggers>
        </asp:UpdatePanel>
                        </div>
    ...
    <br />
    <br />
     <div id="commentpopup1" class="overlay">
...
and SISInstnHR.Institute_Id=SISInstitution.InstID and SISInstnHR.Institute_Id=SISStudentGenInfo.InstID"
                                ProviderName="System.Data.SqlClient">
                                <SelectParameters>
         ...
         <Triggers>
         <asp:PostBackTrigger ControlID="popupStudentGrid" />           
     </Triggers>
        </asp:UpdatePanel>
                         </div>
                    ...
                    <tr>
                        <td>Search By Name:
                         ...
                         <td>Employee ID:
                            ...
                            <asp:TextBox ID="EmployeeID" runat="server"></asp:TextBox></td>
                        <td>
