<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="GrantEntryPIMove.aspx.cs" Inherits="GrantEntry_GrantEntryPIMove" MaintainScrollPositionOnPostback="true" %>
 ...
 <%-- <td >
  ...
  <td>
         <asp:Label ID="Label2" runat="server" Text="Contact Number">
              ...
              <td class="auto-style82"><asp:TextBox ID="txtcontact" runat="server" MaxLength="12" Width="200px"></asp:TextBox>
     </td>
...
<table style="width: 100%">
 ...
 <td class="auto-style50">
     <asp:TextBox ID="TextBoxProjectCommencementDate" Enabled="false" runat="server" Width="120px" ></asp:TextBox>
...
<%--                 <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="None"  ControlToValidate="TextBoxProjectCloseDate" ValidationGroup="validation"
     ...
     <asp:TextBox ID="TextBoxSanctionedamountTotal" runat="server" Enabled="false" Width="120px" ></asp:TextBox>
              ...
              <tr>
                  ...
                  <td class="auto-style33">
                      <asp:DropDownList ID="ddlauditrequired" runat="server" Enabled="false" Width="120px">
 ...
 <td class="auto-style51">
     <asp:TextBox ID="txtNoOFSanctions" runat="server"  Width="120px" Enabled="false" AutoPostBack="true"  ></asp:TextBox>
...
<ItemTemplate>
<asp:TextBox ID="txtNarration" Width="255px" runat="server" Enabled="false" />
</ItemTemplate>
</asp:TemplateField>
     ...
     <br />
            <asp:Panel ID="PnlBank" runat="server" Visible="false" Enabled="false" GroupingText="Fund Received Details"   ForeColor="Black" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"  ScrollBars="Horizontal" > 
<asp:Panel ID="Panel1" runat="server" >
 <table width="92%">
     ...
     <asp:GridView ID="GridView_bank" runat="server" OnRowDataBound="RowDataBoundBank" AutoGenerateColumns="False"    CellPadding="2" ForeColor="#333333" >
...
<ItemTemplate>
<asp:DropDownList ID="ddlSanctionEntryNo" runat="server" Enabled="false" Width="155px" />
...
<ItemTemplate>
    ...
    <asp:TemplateField HeaderText = "Narration">
<ItemTemplate>
<asp:TextBox ID="txtComments" Width="380px" runat="server" Enabled="false"/>
</ItemTemplate>
...
<center></center>
 ...
 <asp:Panel ID="PanelOverhead" runat="server"  Visible="false" Enabled="false" GroupingText="Overhead details" ForeColor="Black" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"   > 
  ...
  <center>
  <asp:GridView ID="grvoverhead" runat="server" OnRowDataBound="RowDataBoundOverhead" AllowPaging="true" AutoGenerateColumns="false"  PageSize="10" ShowFooter="false" ShowHeaderWhenEmpty="true" CellPadding="4">
 <HeaderStyle CssClass="headerstyle"  />
<Columns>
...
<td>Remarks</td>
 ...
 <asp:Panel ID="panelPIMove" runat="server" Visible="true" GroupingText="PI Move Comment" Style="font-weight:bold; border-style:inset;background-color:#E0EBAD"  > 
 <table style="width: 92%">
   <tr>
     <td style="height: 36px; font-weight:normal">
      <asp:Label ID="Label13" runat="server" Text="Comment"  ></asp:Label>
        ...
        <td style="height: 36px">
          <asp:TextBox ID="txtPImovecomment" runat="server" TextMode="MultiLine" Style="border-style:inset none none inset;" 
...
<asp:Panel ID="PanelAmount" runat="server" GroupingText="Incentive Add" width="800px"  Visible="false" CssClass="modelPopup"  Style="font-weight:bold; background-color:#E0EBAD; margin-top: 9px;"  >
...
<asp:TextBox ID="txtAmount" runat="server" Enabled="true"  Text='<%# Bind("Amount") %>'/>
      ...
      <asp:Panel ID="PanelOPAmount" runat="server"  Visible="false" width="800px" CssClass="modelPopup"  Style="font-weight:bold; background-color:#E0EBAD; margin-top: 9px;" >
