<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationLibraryUpdate.aspx.cs" Inherits="Publicationentry" MaintainScrollPositionOnPostback="true" %>
   ...
   <script type = "text/javascript">
       ...
       function setRow(obj) {
           ...
           rowNo.value = rowIndex;
            ...
            <asp:Label ID="lablPanelTitle" runat="server" Text="ePrint Update" Font-Bold="true" ></asp:Label>
            <br />
              <br />
          ...
          <%--      <asp:Label ID="Label2" runat="server" Text="Search" Font-Bold="true" ></asp:Label>
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ...
                ProviderName="System.Data.SqlClient">
                        ...
                        <td style="height: 36px">
                          <asp:TextBox ID="PubIDSearch"  runat="server" Width="108px" ></asp:TextBox>
                        </td>
                         <td style="height: 36px;  color:Black">
                           Title
                        </td>
                        <td style="height: 36px">
                          <asp:TextBox ID="TextBoxWorkItemSearch"  runat="server" Style="border-style:inset none none inset;" Width="216px" ></asp:TextBox>
                        </td>
     ...
     <td>
         <asp:TextBox ID="TextBoxPubId" runat="server"   Width="200px" Enabled="false"></asp:TextBox>
                 ...
                 <td style="height: 36px">
                       ...
                       <asp:TextBox ID="txtboxTitleOfWrkItem" ReadOnly="true" runat="server"   Width="900px" TextMode="MultiLine"></asp:TextBox>
     ...
     <td colspan="3" >
       <asp:TextBox ID="TextBoxcorrespondingAuthor" runat="server"  ></asp:TextBox>
                  ...
                  <%--       <table width="100%">
                           ...
                           <asp:Button ID="BtnAddMU" runat="server" Text="Add New author" onclick="addRow"/> 
...
<%--  <td colspan="6" align="center">
                    ...
                    <tr>
                       ...
                       <asp:ImageButton ID="imageBkCbtn" runat="server" ImageUrl="~/Images/srchImg.gif" OnClientClick="setRow(this)" OnClick="showPop" Enabled="false" />
...
<td style="height: 56px; font-weight:normal"> <asp:Label ID="LabelImpFact5" runat="server" Text="5-Year Impact Factor" ForeColor="Black"  ></asp:Label></td> 
  ...
  <td style="height: 36px; font-weight:normal">  
    ...
    <td  style="font-weight:normal" >  <asp:TextBox ID="TextBoxIssue" ReadOnly="true" runat="server"   Width="150px" Style="border-style:inset none none inset;"></asp:TextBox></td>
     ...
     <td style="font-weight:normal" >   <asp:RadioButtonList ID="RadioButtonListIndexed" runat="server"  Enabled="false"  RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioButtonListIndexedOnSelectedIndexChanged" AutoPostBack="true" Style="border-style:inset none none inset;">
         ...
         <td>
            ...
            <asp:SqlDataSource ID="SqlDataSourcePubBookMonth" runat="server" 
                ...
                ProviderName="System.Data.SqlClient">
                                ...
                                <td style="font-weight:normal;width: 95px;">
                  ...
                  <%--      <td style="height: 36px">
                      ...
                      --%>
                       ...
                       <tr>
                        ...
                        <td style="height: 36px" colspan="3">             
                       <asp:TextBox ID="TextBoxAbstract" ReadOnly="true" runat="server"   Width="900px" TextMode="MultiLine"></asp:TextBox>
        ...
        <asp:SqlDataSource ID="DSforgridview" runat="server" 
            ...
            SelectCommand="  ">
                   ...
                   <td style="height: 36px">
                        ...
                        <td style="height: 36px">
                     <asp:DropDownList ID="DropDownListuploadEPrint" runat="server"
        Width="200px" >
           <asp:ListItem Value="N">No</asp:ListItem>
           <asp:ListItem Value="Y">Yes</asp:ListItem>
                       ...
                       <tr>
                         ...
                         <td style="height: 36px" >
                             ...
                             <asp:Label ID="Labeln" runat="server" Text="*" ForeColor="Red"></asp:Label>
                        </td>
                        <td style="height: 36px" colspan="3">
                     <asp:TextBox ID="TextBoxEprintURL" runat="server" 
        Width="900px" ></asp:TextBox>   
                        ...
                        <td style="height: 36px" colspan="3">
                     <asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" Rows="5" Width="900px" ></asp:TextBox>   
...
<table >
    <tr>
        <td>
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="BtnSave_Click" CausesValidation="true" ValidationGroup="validation" Enabled="false" ></asp:Button>
          </td>
         <td>
         <asp:Button ID="btnSendNotification" CausesValidation="true" runat="server" Visible="true" Text="Send Notification"  ValidationGroup="validation1" OnClick="btnSendNotification_Click" ></asp:Button>
        </td>
 </tr>
</table>
<br />
...
<br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                    ControlToValidate="TextBoxEprintURL" Display="None" 
                                    ErrorMessage="Please Enter a EPrint URL" 
