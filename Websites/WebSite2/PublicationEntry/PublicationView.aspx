<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationView.aspx.cs" Inherits="PublicationView" MaintainScrollPositionOnPostback="true" %>
 ...
 <script type = "text/javascript">
   ...
   <script type = "text/javascript">
     ...
     <div style="margin-top:-30px;float:right;margin-right:140px" >
          <asp:Button ID="BtnBack" runat="server" OnClick="BakButtonClick" Text="Back" />
         </div>
            <asp:ToolkitScriptManager ID="Scriptmanager1" runat="server"/>

            <asp:Label ID="lablPanelTitle" runat="server" Text="Publication View" Font-Bold="true" ></asp:Label>
            <br />
       ...
       <tr>
           ...
           <td colspan="3" style="height: 36px">
               <asp:TextBox ID="TextBoxWorkItemSearch" runat="server" 
                   Style="border-style:inset none none inset;" Width="500px"></asp:TextBox>
           </td>
           <td style="height: 36px; font-weight:normal; color:Black">
               <b>Entered By</b>
           </td>
                   ...
                   Style="border-style:inset none none inset;"></asp:TextBox>
                     ...
                     <tr>
                         ...
                         <td colspan="2" style="height: 36px">
                             <asp:Button ID="ButtonSearchPub" runat="server" 
                                 OnClick="ButtonSearchPubOnClick" Text="Search" />
        ...
        PagerSettings-PageButtonCount="5" PageSize="10" DataSourceID="SqlDataSource1"  EmptyDataText="No Data found"
  ...
  <td>
    ...
    <table border="1" style="width: 100%">
     <tr>
         ...
         <td style="font-weight:normal" class="auto-style19">
                          <asp:Label ID="LabelDOINum" runat="server" Text="DOI Number" Font-Bold="true" ></asp:Label>
                               
                               </td>
                        <td style="height: 36px" colspan="5">             
                             <asp:TextBox ID="TextBoxDOINum" runat="server"   Width="272px" MaxLength="200" Style="border-style:inset none none inset; margin-left: 0px;"></asp:TextBox>
...
<%--  <td colspan="6" align="center">
                    ...
                    <tr>
                        ...
                        <td style="height: 36px" >             
                             <asp:TextBox ID="TextBoxPubJournal" runat="server"   Width="150px" OnTextChanged="JournalIDTextChanged"  AutoPostBack="true" Style="border-style:inset none none inset;"></asp:TextBox>
                 ...
                 <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="imageBkCbtn" PopupControlID="popupPanelJournal"
                    BackgroundCssClass="modelBackground"  >
                        ...
                        <td style="height: 36px" >
                             <asp:TextBox ID="TextBoxNameJournal" runat="server"  ReadOnly="true" Width="300px" Style="border-style:inset none none inset;"></asp:TextBox>
         </td>
  ...
  <asp:ListItem Value="12">Dec</asp:ListItem>
        ...
        Width="80px"  Style="border-style:inset none none inset;" >
           ...
           <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="None"  ControlToValidate="TextBoxYearJA" ValidationGroup="validation"
                ...
                <td style="height: 56px; font-weight:normal"> <asp:Label ID="LabelImpFact" runat="server" Text="1-Year Impact Factor" ForeColor="Black"  ></asp:Label>
    
       <asp:TextBox ID="TextBoxImpFact" runat="server" Width="95px"  ReadOnly="true" Style="border-style:inset none none inset;" ></asp:TextBox>

     </td>
<%--<td class="auto-style20"></td>--%>
<td style="height: 56px; font-weight:normal"> <asp:Label ID="LabelImpFact5" runat="server" Text="5-Year Impact Factor" ForeColor="Black"  ></asp:Label>
     
       <asp:TextBox ID="TextBoxImpFact5" runat="server"  ReadOnly="true" Style="border-style:inset none none inset;" Width="95px" ></asp:TextBox>
...
<asp:SqlDataSource ID="SqlDataSourceCheckboxIndexAgency" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
           SelectCommand="select agencyid,agencyname from IndexAgency_M where active='Y'">
                           ...
                           <tr>
                             ...
                             <asp:Label ID="lblQuartile" runat="server" Text="Quartile On Entry" ForeColor="Black" ></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtquartile" runat="server" ReadOnly="true" Width="100px" Style="border-style:inset none none inset;" ></asp:TextBox>
                        </td>
                        <td  style="font-weight:normal" class="auto-style35">
                             <asp:Label ID="lblQuartileid" runat="server" Text="Quartile On Incentivise" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtquartileid" runat="server" ReadOnly="true" Width="100px" Style="border-style:inset none none inset;"></asp:TextBox>
                        </td>
                           </tr>
                  </table>
...
<%--  <center>
 ...
 <table width="100%" >
          ...
          <tr>
                                 ...
                                 <td style="height: 36px; font-weight:normal;    width: 500px;">
