<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationPostApproval.aspx.cs" Inherits="PublicationPostApproval" MaintainScrollPositionOnPostback="true" %>
...
.blnkImgCSS
{
 ...
 <script type = "text/javascript">
   ...
   <script type = "text/javascript">
       ...
       function setRow(obj) {
           ...
           rowNo.value = rowIndex;
            ...
            <asp:Label ID="lablPanelTitle" runat="server" Text="Publication Post Approval" Font-Bold="true" ></asp:Label>
            <br />
              <br />
   ...
   <asp:ImageButton ID="BtnEdit" runat="server" CausesValidation="False" CommandName="Edit" ImageUrl="~/Images/edit.gif" ToolTip="Edit" Visible="false" />
          ...
          <asp:TemplateField ShowHeader="False">
   <ItemTemplate>
   <asp:Button ID="BtnEditGridViewView" runat="server" CausesValidation="False" CommandName="View"  Text="Post Approval"  ToolTip="Post Approval" />
   </ItemTemplate>
   </asp:TemplateField>
...
<%--  
    ...
    <%--       <asp:BoundField DataField="ImpactFactor" ReadOnly="true" HeaderText="ImpactFactor" 
         ...
         <asp:BoundField DataField="ISStudentAuthor" ReadOnly="true" HeaderText="Student Publication" 
...
<asp:Panel ID="panel" runat="server" GroupingText=" " Visible="false" BackColor="#E0EBAD"> 
 ...
 <br />
    <center><asp:Label runat="server" ID="Incentivenote" Text="Note: Incevtive Point for the following publication is already processed. You cannot update the data"></asp:Label></center>
         ...
         ValidationGroup="validation" ControlToValidate="DropDownListPublicationEntry" Display="None" InitialValue=" "></asp:RequiredFieldValidator>
                        ...
                        <td style="height: 36px" colspan="2">
                            <asp:DropDownList ID="DropDownListMuCategory" runat="server"   Width="200px"  DataSourceID="SqlDataSourceMuCategory" DataTextField="PubCatName"
                              DataValueField="PubCatId" AppendDataBoundItems="true"  Enabled="false">
                                    <asp:ListItem Value=" ">--Select--</asp:ListItem>
     ...
     <td>
         <asp:TextBox ID="TextBoxPubId" runat="server"   Width="200px" Enabled="false"></asp:TextBox>
                 ...
                 <td style="height: 36px">
                       ...
                       <asp:TextBox ID="txtboxTitleOfWrkItem" runat="server"   Width="900px" TextMode="MultiLine" Enabled="false"></asp:TextBox>
       ...
       <asp:TextBox ID="EmployeeCode" runat="server" Width="180" Visible="true" MaxLength="9"></asp:TextBox>
        ...
        <asp:TemplateField HeaderText="Author Name">
             <ItemTemplate>
                 ...
                 <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" TargetControlID="ImageButton1" PopupControlID="popupstudent"
                    BackgroundCssClass="modelBackground"  >
                                  </asp:ModalPopupExtender>
             </ItemTemplate>              
        </asp:TemplateField>
...
<%--  <td colspan="6" align="center">
                    ...
                    <tr>
                        ...
                        <td style="height: 36px" >             
                             <asp:TextBox ID="TextBoxPubJournal" runat="server"  Enabled="false" Width="220px" OnTextChanged="JournalIDTextChanged"  AutoPostBack="true" Style="border-style:inset none none inset;"></asp:TextBox>
     
                       <asp:ImageButton ID="imageBkCbtn" runat="server" ImageUrl="~/Images/srchImg.gif" OnClientClick="setRow(this)" OnClick="showPop" Visible="false" />
                 ...
                 <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="imageBkCbtn" PopupControlID="popupPanelJournal"
                    BackgroundCssClass="modelBackground"  >
                        ...
                        <td style="height: 36px" >
                             <asp:TextBox ID="TextBoxNameJournal" runat="server" Enabled="false"  ReadOnly="true" Width="600px" Style="border-style:inset none none inset;"></asp:TextBox>
         </td>
                       ...
                       <table >
                           <tr>
                             ...
                             <asp:Label ID="LabelMonthJA" runat="server" Text="Publish Month" ForeColor="Black"   ></asp:Label>
                              </td><td><asp:DropDownList ID="DropDownListMonthJA" runat="server" Style="border-style:inset none none inset;" OnSelectedIndexChanged="txtboxYear_TextChanged" AutoPostBack="true"
        >
 ...
 <asp:ListItem Value="11">Nov</asp:ListItem>
  <asp:ListItem Value="12">Dec</asp:ListItem>
                     ...
                     <asp:Label ID="LabelYearJA" runat="server" Text="Publish Year" ForeColor="Black"  ></asp:Label>
                             </td><td> <asp:DropDownList ID="TextBoxYearJA" runat="server" OnSelectedIndexChanged="txtboxYear_TextChanged" AutoPostBack="true"
  ...
  <td style="height: 36px; font-weight:normal">  
         ...
         <td>
      <asp:TextBox ID="TextBoxPageFrom" runat="server"  Width="50px" MaxLength="10" onchange="PagefromChange('TextBoxPageFrom','TextBoxPageTo');" Style="border-style:inset none none inset;"></asp:TextBox> 
   </td>
    ...
    <td  style="font-weight:normal" >  <asp:TextBox ID="TextBoxIssue" runat="server"   Width="100px" Style="border-style:inset none none inset;"></asp:TextBox></td>
     <td style="height: 36px; font-weight:normal">
                        ...
                        <td style="height: 36px">             
                             <asp:TextBox ID="TextBoxDOINum" runat="server"   Width="180px" MaxLength="200" Style="border-style:inset none none inset;"></asp:TextBox>
     ...
     <td style="font-weight:normal" class="auto-style17"> <asp:Label ID="LabelIndexed" runat="server" Text="Indexed:" ForeColor="Black"  ></asp:Label></td>
     <td style="font-weight:normal" class="auto-style16" >   <asp:RadioButtonList ID="RadioButtonListIndexed" runat="server" Enabled="false"    RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioButtonListIndexedOnSelectedIndexChanged" AutoPostBack="true" Style="border-style:inset none none inset;" Width="151px">
     ...
     <td style="font-weight:normal" class="auto-style11">
    

     <asp:Label ID="LabelIndexedIn" runat="server" Text="Indexed In" ForeColor="Black"  ></asp:Label></td>
     <td  style="font-weight:normal" class="auto-style20" >
...
<td><asp:TextBox ID="journalcodeSrch" runat="server" ></asp:TextBox> 
...
<%--  <center>
 ...
 <table width="100%" >
                ...
                TargetControlID="TextBoxDate" Format="dd/MM/yyyy" >
                 ...
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator153" runat="server" Display="None"  ControlToValidate="TextBoxDate" ValidationGroup="validation"
...
<asp:ListItem Value="0">--Select--</asp:ListItem>
     ...
     <td class="auto-style38"></td>
      ...
      <table width="100%">
        ...
        <td style="height: 36px; font-weight:normal;width: 95px;"> <asp:Label ID="LblCPIndexed" runat="server" Text="Indexed:" ForeColor="Black"  ></asp:Label></td>
...
<asp:SqlDataSource ID="SqlDataSourceCheckboxCPIndexAgency" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
      ...
      <td class="auto-style38"></td>
        ...
        <tr>
                        ...
                        <td style="height: 36px; font-weight:normal;width: 93px;">
                           <asp:Label ID="Label2" runat="server" Text="Credit Point" ></asp:Label>
                        </td>
                        <td style="height: 36px">
...
<asp:ListItem Value="0">--Select--</asp:ListItem>
 ...
 <table border="1" style="width: 100%">
                    <tr>
                        ...
                        <td style="height: 36px">             
                             <asp:TextBox ID="TextBoxNewsPublish" runat="server"   Width="200px"></asp:TextBox>
                        ...
                        <td style="height: 36px">
                             <asp:TextBox ID="TextBoxDateOfNewsPublish" runat="server"  Width="200px"></asp:TextBox>
        ...
        Width="900px" ></asp:TextBox>   
                 ...
                 <%--       <td style="height: 36px">
                       ...
                       <tr>
                        ...
                        <td style="height: 36px" colspan="3">             
                       <asp:TextBox ID="TextBoxAbstract" runat="server"   Width="900px" TextMode="MultiLine" ></asp:TextBox>
     ...
     <asp:Label ID="Eprint" runat="server" Text="EPrint" Font-Bold="true"></asp:Label>
      ...
      BorderStyle="Solid">
        ...
        Width="900px" ></asp:TextBox>   
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter the Remarks"
         ValidationGroup="validation1" ControlToValidate="TextBoxRemarks" Display="None" InitialValue=" "></asp:RequiredFieldValidator>
                        </td>
...
<asp:Panel ID="popupPanelAffil" runat="server" style="background:white" Visible="false" CssClass="modelPopup" Width="490px">
...
<tr>
<td>Search By Name:</td><td><asp:TextBox ID="affiliateSrch" runat="server"  ></asp:TextBox> </td></tr>
<tr><td>Search By Id:</td><td> <asp:TextBox ID="SrchId" runat="server"   ></asp:TextBox></td></tr>
  <tr><td></td><td><asp:Button ID="BtnEmployeeSearch" runat="server" Text="Search" OnClick="branchNameChanged" />
 
<asp:Button ID="Button1" runat="server" Text="EXIT" OnClick="exit" /></td>
  
  </tr> 
<tr>
<td colspan="3">
<asp:GridView ID="popGridAffil" runat="server"  AutoGenerateSelectButton="true" EmptyDataText="No User Found"
OnSelectedIndexChanged="popSelected1" AllowSorting="true"  AutoGenerateColumns="false" >
<FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510"  />
        <HeaderStyle BackColor="#0b532d" Font-Bold="True" ForeColor="White" />
        <PagerStyle ForeColor="#000000" HorizontalAlign="Center" />
        <RowStyle BackColor="#FFFFFF" ForeColor="#000000" />
        ...
        <Columns>
         <asp:BoundField DataField="User_Id" HeaderText="User Id" ReadOnly="True" 
            SortExpression="User_Id"  ItemStyle-Width="150px"/>
        <asp:BoundField DataField="Name" HeaderText="Name" ReadOnly="True" 
            SortExpression="Name"  ItemStyle-Width="150px" />
            </Columns>
</asp:GridView>
...
SelectCommand="SELECT User_Id,prefix+' '+firstname+' '+middlename+' '+lastname  as Name,1 flag from User_M where User_Id=(Select CreatedBy from Publication where PublicationID=@ID and TypeOfEntry=@TypeOfEntry)  UNION SELECT top 10  User_Id, prefix+' '+firstname+' '+middlename+' '+lastname  as Name, 2 flag from User_M where Active='Y' order by flag" ProviderName="System.Data.SqlClient">
<SelectParameters>
<asp:ControlParameter Name="ID" ControlID="TextBoxPubId" Type="String" />
<asp:ControlParameter ControlID="DropDownListPublicationEntry" Name="TypeOfEntry" PropertyName="SelectedValue" />
</SelectParameters>
</asp:SqlDataSource>
...
<asp:Panel ID="popupstudent"  style="background:white" runat="server" Visible="false" CssClass="modelPopup" Width="900px" Height="600px">
<table align="center">
<tr>
...
<table>
<tr align="left">
<td>Name: <asp:TextBox ID="txtSrchStudentName" runat="server"   ></asp:TextBox></td> 
<td></td>
<td>Roll No: <asp:TextBox ID="txtSrchStudentRollNo" runat="server"></asp:TextBox></td> 
...
<table>
<tr>
<td colspan="2"><asp:Button ID="Button2" runat="server" Text="Search" OnClick="SearchStudentData" /></td>
<td><asp:Button ID="Button3" runat="server" Text="EXIT" OnClick="exit" /> </td>
</tr>
</table>
</center>
<br />
