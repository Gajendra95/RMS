<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationApproval.aspx.cs" Inherits="PublicationApproval" MaintainScrollPositionOnPostback="true" %>
   ...
   <script type = "text/javascript">
     ...
     <script type = "text/javascript">
         function ConfirmButtonStudentPub() {
             ...
             var reowrk = document.getElementById('<%= DropDownList1App.ClientID %>').value;
             if (reowrk == "REW") {
             }
             else {
                 if (PublicationEntry == "JA" || PublicationEntry == "TS") {
                     if (studentpub == "Y") {
                         if (hdnPredatoryJournal == "PRD") {
                             if (confirm("The article belongs to predatory journal.This will  not be consider for incentive point entry\nThis will be considered as a Student Publication.Do you want to Continue?"))
                                 confirm_value.value = "Yes";
                             else
            ...
            <asp:Label ID="lablPanelTitle" runat="server" Text="Publication Approval" Font-Bold="true" ></asp:Label>
            <br />
              <br />
 ...
 <table border="1" style="width: 100%">
                    <tr>
                        ...
                        <td style="height: 36px" colspan="2">             
                             <asp:DropDownList ID="DropDownListPublicationEntry" runat="server"  DataSourceID="SqlDataSourcePublicationEntry" DataTextField="EntryName"
  ...
  <td>
     ...
     <td>
         ...
         ValidationGroup="validation" ControlToValidate="txtboxTitleOfWrkItem" Display="None"></asp:RequiredFieldValidator>
                         ...
                         <td>
                                     <asp:Label ID="LabelApprove" runat="server" Text="Approve:" Font-Bold="true" ></asp:Label>
                         </td>

                         
                         <td>
                               <asp:DropDownList ID="DropDownList1App" runat="server">
                      <asp:ListItem Value="APP">Accept</asp:ListItem>
                                          <asp:ListItem Value="REW">Reject</asp:ListItem>   
                             </asp:DropDownList> 
                         </td>

                         <td>
                             <asp:Label ID="LabelRemarkFeedback" runat="server" Text="Remark:" Font-Bold="true" ></asp:Label>
                         </td>

                         <td colspan="6">
                                               <asp:TextBox ID="TextBoxRemark" runat="server"   Width="700px" TextMode="MultiLine"></asp:TextBox>
...
<%--
     ...
     <td colspan="3" >
       <asp:TextBox ID="TextBoxcorrespondingAuthor" runat="server"  ></asp:TextBox>
                     ...
                     <asp:Panel ID="panAddAuthor" runat="server" GroupingText="Author Deatils" Visible="false"  Font-Bold="true">
                  <%--       <table width="100%">
...
<br />
  ...
  <asp:Panel ID="panelJournalArticle" runat="server" GroupingText="Journal Publish Details" Visible="false" Enabled="false"  ForeColor="Black"  > 
<%--  <center>
  Journal Article
  </center>--%>
  <br />
...
<%--<td style="height: 56px; font-weight:normal"> <asp:Label ID="lblCitation" runat="server" Text="Citation URL" ForeColor="Black"  ></asp:Label></td> 
    ...
    <td  style="font-weight:normal" >  <asp:TextBox ID="txtCitation" runat="server" MaxLength="200"   Width="480px" Style="border-style:inset none none inset;"></asp:TextBox></td>   --%>
                  </tr>
                  </table>
...
<td><asp:TextBox ID="affiliateSrch" runat="server"  AutoPostBack="true" OnTextChanged="branchNameChanged" ></asp:TextBox> </td>
</tr> 
...
<table width="100%">
    <tr>
        <td align="center">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="BtnSave_Click" Enabled="false" CausesValidation="true" ValidationGroup="validation" Visible="false"></asp:Button>
             <asp:Button ID="ButtonSub" runat="server" Text="Submit" Enabled="false" OnClick="BtnApprove_Click" OnClientClick="ConfirmButtonStudentPub()" ></asp:Button>
...
<br />
    ...
    <asp:HiddenField ID="hdnPredatoryJournal" runat="server" />
