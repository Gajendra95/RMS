<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PrintEvaluationForm.aspx.cs" Inherits="PublicationEntry_PrintEvaluationForm" %>
...
.blnkImgCSS
{
 ...
 <script type = "text/javascript">
   ...
   <script type = "text/javascript">
       ...
       function setRow(obj) {
           ...
           rowNo.value = rowIndex;
            ...
            <asp:Label ID="lablPanelTitle" runat="server" Text="Print Evaluation Form" Font-Bold="true" ></asp:Label>
            <br />
            ...
            <asp:Panel ID="panelSearchPub" runat="server" GroupingText="Search" Font-Bold="true" Style="background-color:#E0EBAD"> 
                 <table border="1" style="width: auto">
                    <tr>
                            ...
                            <asp:DropDownList ID="EntryTypesearch" runat="server" Visible="false"
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                ...
                ProviderName="System.Data.SqlClient">
                        ...
                        <td style="height: 36px" colspan="3">
                          <asp:TextBox ID="TextBoxWorkItemSearch"  Width="300px" runat="server" Style="border-style:inset none none inset;" ></asp:TextBox>
                        </td>
                        <td>
                             <asp:Button ID="ButtonSearchPub" runat="server" Text="Search" OnClick="ButtonSearchPubOnClick"  />
                        </td>
                                
                            <asp:DropDownList ID="drpPubStatusSearch" Visible="false" runat="server"   DataSourceID="SqlDataSource2" DataTextField="StatusName" DataValueField="StatusId" AppendDataBoundItems="true">
             <asp:ListItem Value="A">ALL</asp:ListItem>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                ProviderName="System.Data.SqlClient">
                     ...
                     <tr>
                          ...
                          <asp:TextBox ID="TextBoxEnteredBySearch"  Visible="false" runat="server" Style="border-style:inset none none inset;" ></asp:TextBox>
        ...
        <tr>
                                 ...
                                 <asp:DropDownList ID="DropDownListInst" Visible="false" runat="server" OnSelectedIndexChanged="DropDownListInstOnSelectedIndexChanged" AutoPostBack="true"
     Style="border-style:inset none none inset;" DataSourceID="SqlDataSourceInst" DataTextField="Institute_Name" DataValueField="Institute_Id" AppendDataBoundItems="true">
        ...
        <asp:SqlDataSource ID="SqlDataSourceInst" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
           SelectCommand="select Institute_Id,Institute_Name from Institute_M ">
                                 ...
                                 <asp:DropDownList ID="DropDownListDept" runat="server"  Visible="false"
     Style="border-style:inset none none inset;" DataSourceID="SqlDataSourceDept" DataTextField="DeptName" DataValueField="DeptId" AppendDataBoundItems="true">
        
        <asp:ListItem Value="A">ALL</asp:ListItem>

        </asp:DropDownList>  
        <asp:SqlDataSource ID="SqlDataSourceDept" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
           SelectCommand="">
                        ...
                        <asp:GridView ID="GridViewSearch" runat="server"   AllowPaging="false" OnPageIndexChanging="GridViewSearchPub_PageIndexChanging" 
   ...
   <asp:ImageButton ID="BtnEdit" runat="server" CausesValidation="False" CommandName="Edit" ImageUrl="~/Images/view.gif" ToolTip="View"  />
            ...
            <asp:TemplateField ShowHeader="False" >
   <ItemTemplate>
   <asp:Button ID="ButtonSavepdf" Height="30" Font-Bold="true" runat="server" Text="Print" CommandName="Print"/>
   </ItemTemplate>
   </asp:TemplateField>
...
<%--  <td colspan="6" align="center">
                 ...
                 <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="imageBkCbtn" PopupControlID="popupPanelJournal"
                    BackgroundCssClass="modelBackground"  >
                        ...
                        <td style="height: 36px" >
                             <asp:TextBox ID="TextBoxNameJournal" runat="server"  ReadOnly="true" Width="420px" Style="border-style:inset none none inset;"></asp:TextBox>
         </td>
    ...
    IF Applicable Year:
                        ...
                        <td>  <asp:TextBox ID="txtIFApplicable" runat="server"  ReadOnly="true" Width="60px" Style="border-style:inset none none inset;"></asp:TextBox></td>
 ...
 <asp:ListItem Value="11">Nov</asp:ListItem>
  <asp:ListItem Value="12">Dec</asp:ListItem>
     ...
     <td  >
       <asp:TextBox ID="TextBoxImpFact" Width="80px" runat="server"  ReadOnly="true" Style="border-style:inset none none inset;" ></asp:TextBox>
...
<td style="height: 56px; font-weight:normal"> <asp:Label ID="LabelImpFact5" runat="server" Text="5-Year Impact Factor" ForeColor="Black"  ></asp:Label></td> 
     <td  >
       <asp:TextBox ID="TextBoxImpFact5" runat="server"  ReadOnly="true" Style="border-style:inset none none inset;" Width="80px" ></asp:TextBox>
  ...
  <td style="height: 36px; font-weight:normal">  
    ...
    <td style="height: 36px; font-weight:normal">
                        ...
                        <td style="height: 36px">             
                       <asp:TextBox ID="TextBoxVolume" runat="server"   Width="50px" Style="border-style:inset none none inset;"></asp:TextBox>
    ...
    <td  style="font-weight:normal" >  <asp:TextBox ID="TextBoxIssue" runat="server"   Width="50px" Style="border-style:inset none none inset;"></asp:TextBox></td>
      ...
      <td style="height: 36px; font-weight:normal">
                        ...
                        <td style="height: 36px">             
                             <asp:TextBox ID="TextBoxDOINum" runat="server"   Width="50px" MaxLength="20" Style="border-style:inset none none inset;"></asp:TextBox>
...
<%--  <center>
 ...
 <table  style="width: 100%">
  ...
  <td style="font-weight:normal"> <asp:Label ID="LabelVolume1" runat="server" Text="Volume"  ></asp:Label></td> 
     <td  >
  <asp:TextBox ID="TextBoxVolume1" runat="server"   Width="50px" Style="border-style:inset none none inset;"></asp:TextBox>
...
<br />
 ...
 <table border="1" style="width: 100%">
    ...
    <br />
 <b><asp:Label ID="lblmsg" runat="server" Visible="true" Text="Note: Non indexed articles are not applicable for Print evaluation form"></asp:Label></b>
     <br />

 <b>    <asp:Label ID="Label2" runat="server" Visible="false" Text="Note:Journals of type Book and Letters To Editor are not applicable for Print evaluation form"></asp:Label></b>
    <br />
   <b>  <asp:Label ID="Label5" runat="server" Visible="false" Text="Note:Journals of type  Short Article and Case Reports under Q3 and Q4 Quartiles are not applicable for Print evaluation form"></asp:Label></b>
          <table>
