<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationReportFAIRPRAISEArticleWise.aspx.cs" Inherits="PublicationEntry_Reports_PublicationReportFAIRPRAISEArticleWise" %>
...
<center>
<b>Article Wise FAIR-PRAISE Points</b>
</center>
...
<asp:SqlDataSource ID="SqlDataSourceDept" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" SelectCommand="">
      ...
      <td> 
<asp:Label ID="Label4" runat="server" Text="Member Type " ForeColor="Black"  ></asp:Label>
...
<asp:ListItem Value="F">Faculty</asp:ListItem>
    ...
    <tr>
<td style="height: 56px; font-weight:normal" >
<asp:Label ID="Label2" runat="server" Text="MAHE Categorization" ForeColor="Black"  ></asp:Label>
<asp:DropDownList ID="DropDownListMuCategoryType" runat="server" Style="border-style:inset none none inset;" DataSourceID="SqlDataSourceMuCategoryType" DataTextField="PubCatName" DataValueField="PubCatId" AppendDataBoundItems="true">
<asp:ListItem Value="ALL">ALL</asp:ListItem>
</asp:DropDownList>  
<asp:SqlDataSource ID="SqlDataSourceMuCategoryType" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnectionString %>" 
                   SelectCommand="select PubCatId,PubCatName from PubMUCategorization_M" >
</asp:SqlDataSource>
</td>
    
     <td> 
<asp:Label ID="Label3" runat="server" Text="Article Type" ForeColor="Black"  ></asp:Label>

<asp:DropDownList ID="ddlArticletype" runat="server" Style="border-style:inset none none inset;"  AppendDataBoundItems="true">
<asp:ListItem Value="F">FAIR-Article</asp:ListItem>
    <asp:ListItem Value="P">PRAISE-Article</asp:ListItem>
</asp:DropDownList>  </td>
<td rowspan="2">
<asp:Button id="Button1" runat="server" Text="view" OnClick="viewclick"  BorderColor="Black" Width="90px" Height="40px"  CausesValidation="true" ValidationGroup="validation" /></td>
</tr>
<tr>
<td style="height: 56px; font-weight:normal" >
<asp:Label ID="LabelFromDate" runat="server" Text="From Date" ForeColor="Black"   ></asp:Label>
<asp:TextBox ID="TextBoxFromDate" runat="server"  Style="border-style:inset none none inset;"  >
</asp:TextBox> 
