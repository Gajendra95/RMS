...
public partial class PublicationEntry_Reports_PublicationReportInstitutionWiseHR : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       string instid=Session["InstituteId"].ToString();
       string deptid = Session["Department"].ToString();
       DropDownListInst.Items.Clear();
       //DropDownListInst.Items.Add(new ListItem("ALL", "ALL", true));
       SqlDataSourceInst.SelectCommand = "select Institute_Id,Institute_Name from Institute_M where Institute_Id='" + instid + "'";
       SqlDataSourceInst.DataBind();
       DropDownListInst.DataBind();
       DropDownListInstOnSelectedIndexChanged(sender,e);
    ...
    protected void viewclick(object sender, EventArgs e)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = "/PublicationReports/InstitutionWiseHRReport";
      ...
      //  string UserID = Session["UserId"].ToString();
       ...
       string institution= Session["InstituteId"].ToString();
       DropDownListInst.SelectedValue = institution;
        string Institute = DropDownListInst.SelectedValue;
        ReportParameter p4 = new ReportParameter("Institution", institution);
       

    
     
        ReportParameter[] p = { p2, p4 };
