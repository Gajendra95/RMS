...
public partial class PublicationReportJournalwise : System.Web.UI.Page
{
    ...
    protected void viewclick(object sender, EventArgs e)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = "/PublicationReports/PublicationJournalwise";
     ...
     //   string Institute = DropDownListInst.SelectedValue;
      //  ReportParameter p4 = new ReportParameter("Institution", Institute);
        ...
        ReportParameter[] p = { p2, p21, p3, p31, p41, pstatus };
