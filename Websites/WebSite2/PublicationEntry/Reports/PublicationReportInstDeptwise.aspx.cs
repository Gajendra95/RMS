...
public partial class PublicationReportInstitutewise : System.Web.UI.Page
{
    ...
    protected void viewclick(object sender, EventArgs e)
    {
        ...
        {
            ReportViewer1.ServerReport.ReportPath = "/PublicationReports/PublicationEprintInstDept";
        }
        else
        {
            ReportViewer1.ServerReport.ReportPath = "/PublicationReports/PublicationInstDept";
        }
      ...
      //  string UserID = Session["UserId"].ToString();
       ...
       // ReportParameter pstatus = new ReportParameter("Status", Status);
        ...
        ReportParameter[] p = { p2, p4, p41, p22, p3, studentflag };
