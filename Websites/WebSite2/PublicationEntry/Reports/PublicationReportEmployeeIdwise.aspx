<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationReportEmployeeIdwise.aspx.cs" Inherits="PublicationReportMUEntrywise" %>
...
<center>
<b>Publish Details-EmployeeIDwise</b>
</center>
...
<asp:Label ID="LabelEmployee" runat="server" Text="EmplyeeId" ForeColor="Black"   ></asp:Label>
<asp:TextBox ID="TextBoxEmplyeeId" runat="server" ></asp:TextBox>  
