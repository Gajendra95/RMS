<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="InterInstitutewise.aspx.cs" Inherits="PublicationEntry_Reports_InterInstitutewise" %>
...
<%--<center>
<b>Publish Details-Interdisciplinarywise</b>
</center>--%>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" ScriptMode="Release">
    ...
    <center><b><asp:Label ID="lblnote" Text="Journal Publication Details- Inter Institutions " Visible="false" Font-Size="20px" runat="server"></asp:Label></b></center>
&nbsp;
<br />
