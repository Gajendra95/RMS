<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="PublicationCancellation.aspx.cs" Inherits="Publicationentry" MaintainScrollPositionOnPostback="true" %>
...
.blnkImgCSS
{
 ...
 <script type = "text/javascript">
   ...
   <script type = "text/javascript">
       ...
       function setRow(obj) {
           ...
           rowNo.value = rowIndex;
            ...
            <asp:Label ID="lablPanelTitle" runat="server" Text="Publication Canacellation" Font-Bold="true" ></asp:Label>
            <br />
              <br />
   ...
   <asp:ImageButton ID="BtnEdit" runat="server" CausesValidation="False" CommandName="Edit" ImageUrl="~/Images/edit.gif" ToolTip="Edit" Visible="false" />
          ...
          <asp:TemplateField ShowHeader="False">
   <ItemTemplate>
   <asp:Button ID="BtnEditGridViewView" runat="server" CausesValidation="False" CommandName="View"  Text="Cancel"  ToolTip="Cancel" />
   </ItemTemplate>
   </asp:TemplateField>
...
<table width="100%">
    <tr>
        <td align="center">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Cancel" OnClick="BtnSave_Click" Enabled="false" CausesValidation="true" ValidationGroup="validation"></asp:Button>
