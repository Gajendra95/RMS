<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageRMS.master" AutoEventWireup="true" CodeFile="ProfileView.aspx.cs" Inherits="ProfileView" MaintainScrollPositionOnPostback="true" %>
   ...
   <script type = "text/javascript">
       ...
       function setRow(obj) {
           ...
           rowNo.value = rowIndex;
            ...
            <asp:Label ID="lablPanelTitle" runat="server" Text="Profile View" Font-Bold="true" ></asp:Label>
            <br />
     ...
     <Columns>
        ...
        <asp:TemplateField ShowHeader="false" >
             <ItemTemplate>
                 ...
                 <asp:ImageButton ID="EmployeeCodeBtn" runat="server" ImageUrl="~/Images/srchImg.gif" CssClass="blnkImgCSS" />
            ...
            <asp:SqlDataSource ID="SqlDataSourcePubBookMonth" runat="server" 
                ...
                ProviderName="System.Data.SqlClient">
                    ...
                    <asp:Label ID="Labelpagenum" runat="server" Text="Page Number" ></asp:Label>
                        ...
                        <td style="height: 36px">
                         <asp:TextBox ID="TextBoxPageNum" runat="server"   Width="90px" MaxLength="10" Style="border-style:inset none none inset;"></asp:TextBox>
